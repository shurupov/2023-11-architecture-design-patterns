...
public class InstructionParser {
  ...
  private static final int OBJECT_ID_INDEX = 4;
  private static final int ACTION_NAME_INDEX = 5;
  private static final int ACTION_PARAMETER_INDEX = 6;
  ...
  * */
  public AstNode<?> parse(String dslInstruction) {
